...
## Project Structure
    ...
    ├── newsroom_control_28932  # Django project configurations
...
1. Clone this repo and `cd newsroom_control_28932`
...
2. Clone this repo and `cd newsroom_control_28932`
